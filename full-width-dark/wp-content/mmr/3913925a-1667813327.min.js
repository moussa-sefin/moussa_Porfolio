...
columnStyles();$(this).ajaxComplete(function(){$('style[data-styles="leven-theme-columns-css"]').remove().detach();columnStyles()})});(function($){"use strict";$(document).ready(function($){var mobile_mode_items="",tablet_mode_items="",items="";$('.testimonials').each(function(){var mobile_mode_items=$(this).attr('data-mobile-items'),tablet_mode_items=$(this).attr('data-tablet-items'),items=$(this).attr('data-items'),id=$(this).attr('id');setTimeout(function(){$("#"+id+".testimonials.owl-carousel").owlCarousel({nav:!1,dots:!0,items:1,loop:!0,navText:!1,autoHeight:!0,margin:10,responsive:{0:{items:mobile_mode_items,},768:{items:tablet_mode_items,},1200:{items:items,}}})},100)})})})(jQuery);(function($){"use strict";$(document).ready(function($){var mobile_mode_items="",tablet_mode_items="",items="";$('.clients').each(function(){var mobile_mode_items=$(this).attr('data-mobile-items'),tablet_mode_items=$(this).attr('data-tablet-items'),items=$(this).attr('data-items'),id=$(this).attr('id');setTimeout(function(){$("#"+id+".clients.owl-carousel").imagesLoaded().owlCarousel({nav:!1,items:2,loop:!1,navText:!1,margin:10,autoHeight:!1,responsive:{0:{items:mobile_mode_items,},768:{items:tablet_mode_items,},1200:{items:items,}}})},100)})})})(jQuery)